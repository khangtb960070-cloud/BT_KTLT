...
// Thằng làm Logic va chạm sẽ xài hàm này để lấy ra cái khung bảo vệ của vật thể
...
// Thằng làm giao diện đồ họa sẽ gọi hàm này để biết thực thể đang đứng ở vị trí nào mà render ảnh
